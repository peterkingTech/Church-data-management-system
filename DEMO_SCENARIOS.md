...
3. **Worker** (making contact):
   - Calls newcomer
   - Updates follow-up notes in system
...
### 🔧 Scenario 5: Permission Management (NEW 2025)
**Timeline: Leadership restructure**

#### Permission Assignment
1. **Pastor**:
   - Assigns leadership roles (Head Usher, Choir Lead)
   - Sets department permissions
   - Grants specific access rights

2. **Department Heads**:
   - Receive enhanced permissions
   - Can now manage their departments
   - Access relevant reports and data

### 📋 Scenario 6: Department Reporting Workflow (NEW 2025)
**Timeline: Weekly reporting cycle**
...
9. **Permissions** - Assign leadership roles and permissions
10. **Follow-ups** - Manage newcomer follow-up system
11. **Department Reports** - Review and approve reports
...
- Assign leadership role to worker
...
9. **Follow-ups** - Track newcomer progress
10. **Department Reports** - Submit weekly reports
...
6. **Notices** - View church announcements
7. **Excuses** - Submit absence excuses
...
- ✅ Advanced features (permissions, follow-ups, reports) work
- ✅ Multi-language support functions
- ✅  AMEN TECH branding displays correctly
